...
Apertura App su `http://localhost:8501`
...
- Parsing flessibile: gestione intestazioni su righe multiple e variazioni nei nomi colonna
- Analisi dei limiti con match testuale sulle categorie: se categoria portafoglio non corrispondente a estrazione dal PDF, l'esito sarà "NON RILEVABILE" - verificare manualmente
